...
case
	...
	when embedded_exception is not null
	then 'EMBEDDED_PARSE_EXCEPTION'
	else 'OK'
end as parse_status,
parse_time_millis, ti.mime,
attachment_num, emb_depth, embedded_id, embedded_id_path, embedded_resource_type,
...
container_exception,embedded_exception
from cc_urls u
...
where cpr.id < 1000
order by cpr.id, u.id, attachment_num